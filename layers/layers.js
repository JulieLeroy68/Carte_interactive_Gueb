...
ol.proj.get("EPSG:2154").setExtent([1003081.939692, 6757506.907962, 1022251.517385, 6770056.411812]);
var wms_layers = [];
...
lyr_Sites_5.set('fieldLabels', {'Commune': 'no label', 'Nom': 'header label', 'Type': 'no label', 'Infos supp': 'header label', 'Autres inf': 'no label', 'Statut': 'no label', 'Photo': 'no label', 'Source': 'no label', });
